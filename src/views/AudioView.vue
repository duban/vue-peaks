...
<!--    <p>with Vue.js + Peaks.js</p>-->
    <button @click="toComp1">Component 1</button>
    <button @click="toComp2">Component 2</button>
...
export default {
  ...
  computed: {
    ...mapGetters('programme', ['currentTime', 'introTrack', 'extroTrack','filters']),
  },
  ...
  methods: {
    ...
    toComp1 () {
      this.$store.commit('programme/addFilter', {
        page:'One',
        query: 'One'
      })
